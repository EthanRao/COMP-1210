...
* @param purchasesIn the purchases.
*/
   private void rdeletePurchases(double purchasesIn) {
 ...
 */ 
 ...
 /**
 * @return purchasesPoints.
 * @param nameIn the name.
 */
   public int compareTo(Cardholder nameIn) {
      return name.compareToIgnoreCase(nameIn.getName());
   }
