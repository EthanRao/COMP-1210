...
*/
   ...
   @Test public void currentBalanceTestPositive() {
      ...
      c2.setPrevBalance(2);     
      Assert.assertEquals(100, currentBalanceCompare.compare(c1, c2));
   }
   ...
   @Test public void generateInvalidRecordsReportTest() 
      throws FileNotFoundException {
      CardholderProcessor clist = new CardholderProcessor();
      clist.readCardholderFile("cardholder_data_3_exceptions.txt");
      Assert.assertFalse("generateInvalidRecordsReport",
         clist.generateReportByCurrentBalance().contains("cardholder")); 
   }
